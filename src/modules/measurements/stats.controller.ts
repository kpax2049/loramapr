...
import { MeasurementStatsResult, MeasurementsService } from './measurements.service';
...
export class StatsController {
  ...
  @Get()
  async getStats(@Query() query: StatsQuery): Promise<MeasurementStatsResult> {
    ...
    return this.measurementsService.stats({
